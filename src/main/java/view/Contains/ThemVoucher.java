 ...
 * @author DELL
 */
public class ThemVoucher extends javax.swing.JDialog {

    /**
     * Creates new form Test
     */
    public ThemVoucher(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ThemVoucher dialog = new ThemVoucher(new javax.swing.JFrame(), true);
